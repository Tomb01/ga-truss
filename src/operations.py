...
def solve(nodes: np.array, trusses: np.array, elastic_modulus: float) -> np.array:
    """
    Solve the structure equilibrium equation with displacement method
    ...
    Returns:
        np.array: load and stress matrix solutions
    """
