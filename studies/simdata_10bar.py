...
sparam.aggregation_radius = 0.05*l
sparam.material = Material(1.72e8, 2770, 6.9e10)
sparam.max_area = 0.015
...
eparam.mutation_area = 2
eparam.mutation_connection = 3
eparam.mutation_node_delete = 1
eparam.mutation_node_insert = 1
eparam.mutation_node_position = 3
eparam.node_range = [5,10]
eparam.dynamic_mutation = False
eparam.niche_radius = 0.005
eparam.mass_target = 2300